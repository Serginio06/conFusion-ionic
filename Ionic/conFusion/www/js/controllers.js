...
.controller('AppCtrl', function ($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera) {
    ...
    // Create the register modal that we will use to test camera cordova plugin
   ...
   $scope.register = function () {
    ...
    // Perform the register actions when the user submit form
    ...
    // Add function to take Pictures from camera for user registration form
...
.controller('FavoritesController', ['$scope', 'dishes', 'favorites', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', function ($scope, dishes, favorites, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout) {
    ...
    console.log("Dishes= " + $scope.dishes + " and Favorites= ", $scope.favorites);
    ...
    $scope.deleteFavorite = function (index) {
        ...
        confirmPopup.then(function (res) {
            if (res) {
                console.log('Ok to delete from Favorites');
                favoriteFactory.deleteFromFavorite(index);

            } else {
                console.log('Deleting from Favorites canceled');
            }
